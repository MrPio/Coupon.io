        ...
        @can('isAdmin')
            <div class="right-container">
                <div class="edit-object center-content">
                    <div class="faq--button-container edit-button-container center-content">
                ...
                <div class="delete-object center-content">
                    <form action="{{ route('faqs.destroy', [$faq->id]) }}" method="POST"  onsubmit="return confirm('Sei sicuro di voler cancellare la FAQ n° {{ $faq->id }}?');">
                        @method('DELETE')
                        @csrf
                        <div class="faq--button-container delete-button-container center-content">
                            <button type="submit" style="background-color: rgb(0, 0, 0, 0); border: none">
                                <svg viewBox="64 64 896 896" width="32" height="32">
                                    <path
