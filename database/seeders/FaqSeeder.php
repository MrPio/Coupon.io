    ...
    public function run()
    {
        $faqs = [
            [
                ...
                'answer' => ' Un coupon è un documento stampabile che permette di usufruire di un\' offerta su un prodotto specifico.'

            ],
            [
                'question' => "Come posso acquisire un coupon",
                'answer' => "Per poter acquisire un coupon è necessario registrarsi e accedere al proprio account.Una volta fatto ciò è possibile sfogliare il catalogo e selezionare la promozione di interesse perpoterne acquisire il relativo coupon. Quest'ultimo può essere poi reperito sotto forma di documentostampabile nella propria pagina utente. ",
            ],
            [
                'question' => "Ci sono delle limitazioni per poter utilizzare un coupon",
                'answer' => "Si. Per poter acquisire un coupon è necessario disporre di un account valido ed essereautenticati al sito. Inoltre non è possibile acquisire il coupon di una promozione al seguitodella scadenza della stessa oppure a seguito del termine della disponibilità. ",
            ],
            [
                'question' => "In che modo posso cercare le promozioni di mio interesse",
                'answer' => "Sfogliando il catalogo è possibile selezionare sia l'azienda che la tipologia della promozione di proprio interesse. Inoltre è possibile filtrare il prodotto al quale la promozione di interesse è riferita.",
            ],
            [
                'question' => "Dove posso trovare la lista delle aziende delle quali posso acquisire coupon",
                'answer' => "Nella pagina dedicata è possibile trovare una lista di tutte le aziende che collaborano con noi. È possibile inoltre visualizzare le informazioni relative alla stessa selezionandone una.",
